...
function HighLights2022() {
  ...
  return (
    <div className='h-auto gap-[3rem] py-[5rem] px-[2rem]'>
      <Breadcrumbs link1="/AURA-website/" link2="/AURA-website/PastYearEvents" currentLink="/AURA-website/HighLights2022" link1Name="Home" link2Name="Past Events" currentLinkName="AURA 2022"/>
      <div className=''>
