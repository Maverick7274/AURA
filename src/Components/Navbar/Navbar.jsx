        ...
        <div className="navbar-start">
          <div className="dropdown font-space-mono text-[2rem] font-[500]">
            ...
            >
              ...
              <li>
                <NavLink to="/PastYearEvents">Past Events</NavLink>
              </li>
              <li>
              ...
              <li>
                <NavLink to="/events" className="">
                  Events<div className="badge badge-accent badge-xs"></div>
                </NavLink>
              </li>
              {/* <li>
          ...
          <div className="">
            <NavLink
              to="/"
              className="cursor-pointer hidden lg:flex flex gap-[1rem] justify-center items-center"
            >
              <img src={logo} width="50px" height="50px" />
              <span className="font-josefin-sans font-[700] normal-case text-3xl">
                AURA FEST
              </span>
            </NavLink>
          </div>
