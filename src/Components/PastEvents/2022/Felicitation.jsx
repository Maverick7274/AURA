...
function Felicitation() {
  ...
  return (
    <div className='py-[5rem] px-[2rem]'>
        <div>
        <Breadcrumbs link1="/PastYearEvents" link2="/Highlights2022" currentLink="/Highlights2022/Felicitation" link1Name="Past Events" link2Name="AURA 2022" currentLinkName="Felicitation"/>
            <div>
