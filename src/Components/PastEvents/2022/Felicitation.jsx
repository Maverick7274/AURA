...
function Felicitation() {
  ...
  return (
    <div className='py-[5rem] px-[2rem]'>
        <div>
        <Breadcrumbs link1="/AURA-website/PastYearEvents" link2="/AURA-website/Highlights2022" currentLink="/AURA-website/Felicitation" link1Name="Past Events" link2Name="AURA 2022" currentLinkName="Felicitation"/>
            <div>
