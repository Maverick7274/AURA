  ...
  return (
    <div className='h-auto gap-[3rem] py-[5rem] px-[2rem]'>
      ...
      <div className='flex flex-wrap justify-center items-center gap-[3rem] sm:flex-row md:flex-col xl:flex-row'>
        <ButtonComponent cover={showcase_1} link='/Highlights2022/PreEvent' Heading='Pre Event'/>
        <ButtonComponent cover={showcase_19} link='/Highlights2022/FashionShow' Heading='Fashion Show'/>
        <ButtonComponent cover={showcase_81} link='/Highlights2022/CelebrityNight' Heading='Celebrity Night'/>
        <ButtonComponent cover={showcase_30} link='/Highlights2022/Felicitation' Heading='Felicitation'/>
        <ButtonComponent cover={showcase_83} link='/Highlights2022/PostEvent' Heading='Post Event'/>
      </div>
