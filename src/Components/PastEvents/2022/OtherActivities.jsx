  ...
  return (
    <div className='h-auto flex flex-col justify-center items-center gap-[5rem]'>
        <div className="mt-[6rem]">
            <Breadcrumbs link1="/PastYearEvents" link2="/Highlights2022Day1" currentLink="/otherActivities" link1Name="Past Year Events" link2Name="Day 1" currentLinkName="Other Activities"/>
        </div>
    <div className=''>
        <div className=''>
    ...
    <div className='flex flex-wrap justify-center items-center gap-[3rem] sm:flex-row md:flex-col xl:flex-row'>
      <ButtonComponent cover="https://res.cloudinary.com/djqnbowat/image/upload/v1687023923/ANKITA/4H3A0854_xeanaz.jpg" link="/PanacheFS" Heading='Panache'/>
    </div>
