  ...
  return (
    <div className='h-auto gap-[3rem] py-[5rem] px-[2rem]'>
      <div className='mt-[2rem]'>
        <Breadcrumbs link1="/PastYearEvents" link2="/AURA2022Days" currentLink="/HighLights2022Day2" link1Name="Past Year Events" link2Name="Days" currentLinkName="Day 2"/>
      </div>
      <div className=''>
      ...
      <div className='flex flex-wrap justify-center items-center gap-[3rem] sm:flex-row md:flex-col xl:flex-row'>
        <ButtonComponent cover="https://res.cloudinary.com/djqnbowat/image/upload/v1687031147/Day_2_Showcase_34_h7raf9.jpg" link='/Day2Photos' Heading='Photos'/>
        <ButtonComponent cover="https://res.cloudinary.com/djqnbowat/image/upload/v1687031163/Day_2_Showcase_57_w9dwvz.jpg" link='/Day2Videos' Heading='Videos'/>
      </div>
