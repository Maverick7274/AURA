        ...
        <div className="navbar fixed top-0 z-[1000] left-0 bg-base-100 border-b-2 border-b-white">
            <div className="navbar-start">
                ...
                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                    <li><Link to="/AURA-website/">Home</Link></li>
                    <li><Link to='/AURA-website/about'>About</Link></li>
                    <li><Link to='/AURA-website/contact'>Contact Us</Link></li>
                    <li><Link to='/AURA-website/PastYearEvents'>Past Events</Link></li>
                </ul>
                </div>
                <Link to='/AURA-website/' className="btn btn-ghost normal-case font-righteous text-xl">Aura Fest</Link>
            </div>
