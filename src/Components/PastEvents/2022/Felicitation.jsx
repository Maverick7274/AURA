...
function Felicitation() {
  ...
  return (
    <div className='py-[5rem] px-[2rem]'>
        <div>
        <Breadcrumbs link1="/AURA/PastYearEvents" link2="/AURA/Highlights2022" currentLink="/AURA/Felicitation" link1Name="Past Events" link2Name="AURA 2022" currentLinkName="Felicitation"/>
            <div>
