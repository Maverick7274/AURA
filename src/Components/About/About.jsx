    ...
    <div>
      <div className="h-auto">
        ...
        <div className='h-full w-full'>
          ...
          <div className="">
            <motion.h1 variants={variants} initial='hidden' whileInView='visible' className="py-[1rem] text-center min-[280px]:text-[1.7rem] sm:text-[4rem] text-[2rem] font-bold font-rubik">About Us</motion.h1>
          </div>
          <div className="px-[20rem] text-justify">
            <motion.p variants={variants} initial='hidden' whileInView='visible' className="text-[1.2rem] font-rubik">
            ...
            <motion.p variants={variants} initial='hidden' whileInView='visible' className="text-[1.2rem] font-rubik">
            Organized by the passionate and dedicated students of <a href='https://www.amity.edu/greaternoida/' rel="noreferrer" target='_blank' className='underline underline-offset-2 hover:underline-offset-4 decoration-success duration-500 cursor-pointer hover:text-orange-500'>Amity University, Greater Noida</a> our festival promises a memorable and enriching experience for all participants.
            </motion.p>
          </div>
        ...
        <div id='highlights' className="h-screen flex flex-col justify-center items-center">
          ...
          <div className="px-[20rem] text-justify">
            <ul className='list-disc'>
              <motion.li variants={variants} initial='hidden' whileInView='visible' className="text-[1.2rem] font-rubik py-[1rem]">
