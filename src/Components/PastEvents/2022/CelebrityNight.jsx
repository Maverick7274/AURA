...
function CelebrityNight() {
  ...
  return (
    <div className='py-[5rem] px-[2rem]'>
        ...
        <Breadcrumbs link1="/PastYearEvents" link2="/Highlights2022Day1" currentLink="/CelebrityNight" link1Name="Past Year Events" link2Name="Day 1" currentLinkName="Celebrity Night"/>
            <div>
